				...
				<TabsContent value='ai' className='space-y-4'>
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Get personalized practice plans based on your stats and goals
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className='space-y-4'>
								...
								<div className='grid gap-4 md:grid-cols-2'>
									<Card>
										...
										<CardContent className='pb-2'>
											<p className='text-sm'>
												Your putting stats show you're losing the most strokes on
												the green. Focus on 6-10 foot putts.
											</p>
										</CardContent>
										<CardContent className='pt-0'>
											<Button
												...
												onClick={() =>
													router.push(
														`/dashboard/practice/session?planId=ai-putting`
													)
												}>
												Start Plan
											</Button>
									...
									<Card>
										...
										<CardContent className='pb-2'>
											<p className='text-sm'>
												Work on 100-150 yard approach shots to improve your GIR
												percentage.
											</p>
										</CardContent>
										<CardContent className='pt-0'>
											<Button
												...
												onClick={() =>
													router.push(
														`/dashboard/practice/session?planId=ai-approach`
													)
												}>
												Start Plan
											</Button>
			...
			<Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
				<DialogContent className='sm:max-w-[600px]'>
					<DialogHeader>
						...
						<DialogDescription>
							Customize your practice plan based on your needs and available time
						</DialogDescription>
					</DialogHeader>
					<div className='py-4'>
						<PracticeCreator
